      ...
      <header className="page-header">
        ...
        <div className="toolbar">
          <div className="toolbar-group">
            <button className="btn-ghost" title="Zoom In"><ZoomIn size={16} /></button>
            <button className="btn-ghost" title="Zoom Out"><ZoomOut size={16} /></button>
            <button className="btn-ghost" title="Fit to Screen"><Maximize size={16} /></button>
          </div>
          <div className="toolbar-group">
            <button className="btn-ghost active" title="Breadth-first Layout"><Layout size={16} /></button>
            <button className="btn-ghost" title="Force-directed Layout"><Network size={16} /></button>
          </div>
        </div>
      </header>
